...
dependencies {
    ...
    testImplementation(project(":supabase-auth-admin"))
    testImplementation(project(":supabase-auth-passkey"))
    testImplementation(project(":supabase-storage"))
    testImplementation(project(":supabase-realtime"))
    testImplementation(project(":supabase-functions"))
