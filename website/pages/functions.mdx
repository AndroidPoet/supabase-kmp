...
The `FunctionRegion` enum currently exposes these five values: `US_EAST_1`,
`US_WEST_1`, `EU_WEST_1`, `AP_SOUTHEAST_1`, `AP_NORTHEAST_1`. (Supabase serves
more edge regions than this; if you need one that isn't listed, leave `region`
unset and let Supabase route the call.)
