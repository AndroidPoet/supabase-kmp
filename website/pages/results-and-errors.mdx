...
description: Every call returns a SupabaseResult — a success-or-failure box you branch on with onSuccess/onFailure. Learn the error categories and transforms.
---
...
when (result.errorOrNull()?.category) {
    ...
    SupabaseErrorCategory.NOT_FOUND -> /* 404 */
    SupabaseErrorCategory.UNAUTHORIZED -> /* 401 / 403 */
    SupabaseErrorCategory.RATE_LIMITED -> /* 429 */
