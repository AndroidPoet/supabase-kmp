...
— a Spring Boot service with Users + Products CRUD, auto-generated OpenAPI/Swagger,
and the whole object graph wired with [Metro DI](https://github.com/ZacSweers/metro).
...
RFC 7807 Problem Details errors, health probes, auto-generated OpenAPI + Swagger
UI, and Metro DI building the object graph. Clone it, point it at your project,
