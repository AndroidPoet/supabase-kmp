...
/**
 * Default [SupabaseClient] implementation that delegates all network I/O
 * to [HttpTransport].
 *
 * Endpoint strings are resolved relative to [projectUrl] — callers pass
 * paths like `/rest/v1/todos` and the transport handles the rest.
 */
