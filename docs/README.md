...
4. [Database Guide](guides/database.md)
5. [Production Checklist](operations/production-checklist.md)
...
- MkDocs (primary): `mkdocs.yml` + `docs/`
- GitBook (existing): `.gitbook.yaml` + `docs/`
